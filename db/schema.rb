...
ActiveRecord::Schema.define(version: 20161116092143) do
  ...
  add_index "ahoy_events", ["properties"], name: "index_ahoy_events_on_properties", using: :gin
  ...
  add_index "segments_users", ["segment_id", "user_id"], name: "index_segments_users_on_segment_id_and_user_id", unique: true, using: :btree
